    ...
    public class CameraHandler : MonoBehaviour
    {
        ...
        public void HandleCameraRotation(float delta, float mouseXInput, float mouseYInput)
        {
            if (inputHandler.lockOnFlag == false && currentLockOnTarget == null)
            {
                ...
                myTransform.DORotateQuaternion(targetRotation, 1f);
                ...
                cameraPivotTransform.DOLocalRotateQuaternion(targetRotation, 1f);
            }
            else
            {
                float velocity = 0;
                ...
                eulerAngle.y = 0;
                // cameraPivotTransform.rotation = Quaternion.Euler(eulerAngle);
                // cameraPivotTransform.localEulerAngles = eulerAngle;
                cameraPivotTransform.DOLocalRotate(eulerAngle, 1f, RotateMode.Fast);

                // cameraPivotTransform.position = Vector3.SmoothDamp(cameraPivotTransform.position, nearestLockOnTarget.position, ref cameraFollowVelocity, delta / 0.2f);
            }
